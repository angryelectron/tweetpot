...
4. Run "ant jar -D[win32|win64|linux-i686|linux-x64|mac]"

For example, "ant jar -Dwin64" will build and install the correct RXTX native
libraries to use tweetpot on 64-bit windows.  The output is found in
./tweetpot/java/tweetpot/dist.

Configure
---------
1. Get a Twitter API key and tokens from http://dev.twitter.com
2. Change to ./tweetpot/java/tweetpot/dist
